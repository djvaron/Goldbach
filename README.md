...
## 4. OpenMP
We implemented OpenMP and parallelized our code across 1 to 32 threads on the `huce_intel` partition and generated the figure below for a problem size of 10<sup>10<\sup>.  
